...
mydb=mysql.connector.connect(host="localhost",user="root",password="Sugam@1710")
...
mycursor.execute("""create table if not exists Available_Books(BookName varchar(30) primary key,Genre varchar(20),Quantity int(3),Author varchar(20)
                 ,Price int(4))""")
mycursor.execute("""create table if not exists Sell_rec(CustomerName varchar(25),PhoneNumber char(10) , BookName varchar(30),Quantity int(5),TotalAmt int(5)
                 , Cashier varchar(30))""")
mycursor.execute("""create table if not exists Staff_details(EmpID int(3) unique key,Name varchar(30), Gender varchar(10),Age int(3), PhoneNumber char(10),
                 Sale_Amt int(5) default 0)""" )       
